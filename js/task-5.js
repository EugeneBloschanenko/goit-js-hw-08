...
const showUsedColor = document.querySelector('.color');
const colorChangerButton = document.querySelector('.change-color');

colorChangerButton.addEventListener('click', handleClick);

function handleClick () {
  showUsedColor.textContent = getRandomHexColor();
